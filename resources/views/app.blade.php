    ...
    <div id="app" class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 fixed">
            ...
            <a href="{{url('home')}}" class="brand-link">
                <img src="{{asset('asset/logo-ikapen.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
              ...
              <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <a href="{{url('/pengurus/home/profile')}}">
                    <div class="image">
                        @if (Auth::user()->is_pengurus === 1)
                            <img src="/foto_pengurus{{Auth::user()->foto}}" class="rounded-circle" width="40" height="40" alt="User Image">
                        @elseif (Auth::user()->is_anggota === 1)
                            <img src="/foto_anggota/{{Auth::user()->foto}}" class="rounded-circle" width="40" height="40" alt="User Image">
                        @endif
                    </div>
                    <div class="info">                      
